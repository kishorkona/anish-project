			...
			<c:forEach items="${data}" var="current">
		        <tr>
					...
					<td align="left">
						...
						<a href="\anishtestsnew/sets/updateResultStatus/${current.questionId}/${user_name_key}/1/${current.id}">Need Practice</a>&nbsp;/
						<a href="\anishtestsnew/sets/updateResultStatus/${current.questionId}/${user_name_key}/2/${current.id}">Good</a>&nbsp;/
						<a href="\anishtestsnew/sets/updateResultStatus/${current.questionId}/${user_name_key}/3/${current.id}">Skiped</a>
						&nbsp;|&nbsp;
