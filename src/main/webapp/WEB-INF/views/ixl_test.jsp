...
<body onload="setCurrentTime()">
	...
	<br/><br/>
	<hr/><br/>
<form:form action="/anishtestsnew/tests/nextQuestion" method="post" modelAttribute="question" autocomplete="off">	
		...
		<tr>
			...
			<td style="width:70%;">
				<table class="center" style="width:90%">
					...
					<tr><td colspan="2"><br/></td></tr>
					<tr><td colspan="2">
						<input type="radio" onclick="enableSubmitBtn()" id="questionType" name="questionType" value="2"/>Easy &nbsp;&nbsp;&nbsp;
						<input type="radio" onclick="enableSubmitBtn()" id="questionType" name="questionType" value="1"/>Need Practice &nbsp;&nbsp;&nbsp;
						<input type="radio" onclick="enableSubmitBtn()" id="questionType" name="questionType" value="3"/>More Practice
					</td></tr>
					<tr><td colspan="2"><br/></td></tr>
