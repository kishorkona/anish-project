...
public class Question {
	...
	public String toString() {
		return "Question{" +
				...
				", resultsClean=" + resultsClean +
				", existingTests=" + existingTests +
				", setValue='" + setValue + '\'' +
				", wordProbleum=" + wordProbleum +
				'}';
	}
	...
	public String getQuestionEdTime() {
		return questionEdTime;
	}

	public void setQuestionEdTime(String questionEdTime) {
		this.questionEdTime = questionEdTime;
	}

	public String getQuestionStTime() {
		return questionStTime;
	}

	public void setQuestionStTime(String questionStTime) {
		this.questionStTime = questionStTime;
	}
